...
export function StepTwo({caseData,setCaseData}) {
    ...
    return (
        <div className="h-full flex flex-col gap-6 pt-10">
            ...
            <MainInputMoney label="Valor da ação (opcional)" placeholder="Insira o valor da acão" value={caseData.valor} onChange={(e) => setCaseData({ ...caseData, valor: e.target.value })}/>
