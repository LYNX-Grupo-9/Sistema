...
export function CustomerDetails() {
    return ( 
            <div className="flex w-screen h-screen bg-[var(--bgColor-primary))]">
                <Layout />
                <div className="px-[3%] pt-[80px] flex gap-10 w-full h-full ">
                    <div className="flex flex-col gap-6 w-full">
                        <div className="bgGlass w-[100%] h-[10%] flex justify-center items-center">
                            <span className="typography-semibold text-3xl text-[var(--color-blueDark)]">Lewis Carl Davidson Hamilton</span>
                        </div>
                        <div className="bgGlass w-full h-[70%] flex flex-col items-center gap-5 p-[5%]">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="bgGlass w-[100%] h-[40%]">
                        ...
                        <div className="bgGlass w-[100%] h-[50%]">
